...
<body>
    ...
    <h3>3.3 Define three variables: $g1 = 5, $g2 = 4, and $g3 = 5. These variables represent the grades of three students 
        in the course. To display this information, create an HTML table within your PHP code. The table should be 
    ...
    <img src="image\24.png" alt="web development enviroment" width="800" height="200"> 
